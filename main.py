...
s2reset_button = Button(background_normal='Fenix.jpg', background_down='Fenix.jpg', size_hint=(0.65,1), pos_hint={'center_x': .5, 'center_y': .5})
foodcounterscreenlayout = BoxLayout()
foodcounterscreenlayout.add_widget(s2reset_button)
